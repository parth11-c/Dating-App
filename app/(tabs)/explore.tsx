        ...
        ListHeaderComponent={
          <View>
            <View style={styles.header}>
              ...
              <Text style={[styles.subtitle, { color: colors.icon }]}>Browse curated destinations and experiences</Text>
            </View>
            <View style={styles.searchRow}>
              <SearchBar value={query} onChange={setQuery} />
            </View>
            <CategoryChips categories={travelCategories} selected={category} onSelect={setCategory} />
          </View>
        }
